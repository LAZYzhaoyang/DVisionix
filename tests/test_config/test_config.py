...
if __name__ == "__main__":
    ...
    print("ok test_config_from_dict")
    test_config_dot_access()
    print("ok test_config_dot_access")
    test_config_set()
    print("ok test_config_set")
    test_config_merge()
    print("ok test_config_merge")
    test_config_yaml_roundtrip()
    print("ok test_config_yaml_roundtrip")
    test_config_inheritance()
    print("ok test_config_inheritance")
    test_config_default()
    print("ok test_config_default")
    test_config_validate()
    print("ok test_config_validate")
